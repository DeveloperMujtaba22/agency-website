  ...
  return (
    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <ul className='flex gap-8 '>
                    <li><a className='hover:text-blue-600' href="#hero">Home</a></li>
            ...
            className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    <button className='bg-blue-900 text-white rounded px-6'>Subscribe</button>
                </div>
        ...
        className='pb-6 text-sm text-gray-500 flex justify-between sm:justify-between gap-4 flex-wrap'>
            <p>copyright 2025 @ Mujtaba - All Right Reserved.</p>
